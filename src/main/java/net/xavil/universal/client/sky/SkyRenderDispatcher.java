...
public class SkyRenderDispatcher {
	...
	// 	final var currentSystemId = currentLocation.system();
	...
	// private boolean drawWorldSky(SystemNodeId id) {}
	...
	// 		return drawStationSky();
	// 	}

	// 	final var universe = MinecraftClientAccessor.getUniverse(this.client);
	// 	final var currentNodeUntyped = universe.getSystemNode(currentLocation).unwrapOrNull();
	...
	// 	var currentSystem = universe.getSystem(currentLocation.system()).unwrap();
	...
	// 	drawGalaxyFromVertexBuffer(RenderSystem.getModelViewMatrix(), starSphereProj);
	// 	profiler.popPush("stars");
	// 	drawStarsFromVertexBuffer(RenderSystem.getModelViewMatrix(), starSphereProj);
	// 	profiler.popPush("system");
	// 	drawSystem(celestialCamera, currentLocation, time, partialTick);
	// 	profiler.pop();
