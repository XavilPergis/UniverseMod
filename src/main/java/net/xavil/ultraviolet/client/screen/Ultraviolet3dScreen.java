...
public abstract class Ultraviolet3dScreen extends UltravioletScreen {
	...
	public static abstract class Layer3d extends Layer2d {
		...
		public Layer3d(Ultraviolet3dScreen attachedScreen, CameraConfig cameraConfig) {
	...
	protected Ultraviolet3dScreen(Component component, Screen previousScreen, OrbitCamera camera,
