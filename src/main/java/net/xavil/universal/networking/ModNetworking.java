...
public class ModNetworking {
	...
	public static final ResourceLocation SERVERBOUND_OPEN_STARMAP = Mod.namespaced("serverbound_open_starmap");
	...
	public static void registerClientside() {
		ClientPlayNetworking.registerGlobalReceiver(CLIENTBOUND_UNIVERSE_INFO,
				...
				(client, handler, buf, responseSender) -> {
					var packet = new ClientboundOpenStarmapPacket();
					packet.read(buf);
					client.execute(() -> ClientMod.handlePacket(packet));
				});
	}
	...
	public static void registerServerside() {
		ServerPlayNetworking.registerGlobalReceiver(SERVERBOUND_OPEN_STARMAP, ServerboundOpenStarmapPacket::receive);
	}
